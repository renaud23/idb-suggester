...
export const ON_HOME_DOWN_INPUT = 'renaud-suggester/onHomeDownInput';
export const onHomeDownInput = () => ({ type: ON_HOME_DOWN_INPUT });

export const ON_END_DOWN_INPUT = 'renaud-suggester/onEndDownInput';
export const onEndDownInput = () => ({ type: ON_END_DOWN_INPUT });
 ...
 *
 */
export const ON_MOUSE_ENTER_INPUT_LAYER = 'renaud-suggester/onMouseEnterInputLayer';
